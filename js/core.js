...
'use strict';
    ...
    function aplicarTraduccionesEstaticas() {
      ...
      setText('#acceso-tab-entrar', 'access.tabLogin');
      setText('#acceso-tab-crear', 'access.tabSignup');
      setText('label[for="acceso-email"]', 'common.email');
      setText('label[for="acceso-pass"]', 'access.passLabel');
      setText('#acceso-verpass-1', 'access.showPass');
      setText('#acceso-entrar-btn', 'access.enter');
      setText('label[for="acceso-su-email"]', 'common.email');
      setText('label[for="acceso-su-pass"]', 'access.passLabelMin');
      setText('label[for="acceso-su-pass2"]', 'access.passRepeat');
      setText('#acceso-verpass-2', 'access.showPass');
      setText('#acceso-crear-btn', 'access.createCta');
    ...
    function filaRolSesion(r) {
      ...
      // El panel se abre con la cuenta: el servidor resuelve el centro desde el
      // claim `panelLugarId`, asi que el enlace ya no lleva token.
